...
window.onload = function()
{
	...
	nomDiv("btnjuega").addEventListener("click", function(e)
	{
		...
		{
			var extension = ".png";
			if(jugada_humano.value == 6)
			{
				extension = ".gif";
			}
			console.log(jugada_humano.value);
			console.log(pcc);
			nomDiv("imagenPrueba").src = "imagenes/img_" + jugada_humano.value + extension;	
			nomDiv("imagenPrueba2").src = "imagenes/img_" + pcc + extension;	
		}
	});
	//Expresada...
	function jugar()
		...
		juego_user_pc(humano, pc, function(gana, mensaje)
		{
			...
			else
			{
				if(gana === humano)
				{
					txt = "Gana el Humano";
					puntua[0]++;
					nomDiv("pun_1").innerHTML = "Ganadas: " +puntua[0];
				}
				else
				{
					txt = "Gana el ROBOT";
					puntua[1]++;
					nomDiv("pun_2").innerHTML = "Ganadas: " +puntua[1];	
				}
