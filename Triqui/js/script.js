	...
	function procesarJugada(fichaLlega, jugador)
	{
		...
		else
		{
			if(hayTriqui)
			{
				...
				if(jugador - 1 == 1){
				document.getElementById('x').pause();// pausa sonido de fondo
				document.getElementById('a').play();//reproduce sonido si gana
				alert("Ha hecho triqui El " + nomJugador[jugador - 1]);
				}
				else
				{
				document.getElementById('x').pause();// pausa sonido de fondo
				document.getElementById('b').play();//reproduce sonido si pierde
				alert("Ha hecho triqui El " + nomJugador[jugador - 1]);
				}
			...
			{
				document.getElementById('x').pause();// pausa sonido de fondo
				document.getElementById('c').play();//reproduce sonido si empata
				alert("El juego ha quedao en Tablas");
			}
			terminaJuego = true;
		}
		document.getElementById('x').play();// Reproduce sonido de fondo
	}
